				...
				<div class="row g-0">
					...
					<div class="col-12 col-xl-7 col-xxl-8 auth-cover-left align-items-center justify-content-center d-none d-xl-flex">
                        ...
                        <div class="card shadow-none bg-transparent shadow-none rounded-0 mb-0">
							<div class="card-body">
                                 <img src="<?= base_url('assets/');?>images/login-images/login-cover.svg" class="img-fluid auth-img-cover-login" width="650" alt=""/>
							</div>
						</div>
									...
									<div class="form-body">
										<form class="row g-3">
											<div class="col-12">
												...
												<input type="text" class="form-control" id="email" name="email" placeholder="jhon@example.com">
											</div>
											<div class="col-12">
											...
											<div class="col-12">
												<div class="text-center ">
													<p class="mb-0">Belum punya akun? <a href="<?= base_url('auth/register'); ?>">Register disini</a>
													</p>
												</div>
											</div>
										</form>
